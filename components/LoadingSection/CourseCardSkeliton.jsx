...
export const Item = () =>{
    return (
        ...
        <div className="h-48 rounded-t skeleton"></div>
        <div className="flex-1 px-4 py-8 space-y-4  sm:p-8 bg-slate-200">
            <div className="w-full h-6 rounded skeleton bg-gray-300"></div>
            <div className="w-full h-6 rounded skeleton bg-gray-300"></div>
            <div className="w-3/4 h-6 rounded skeleton bg-gray-300"></div>
        </div>
    </div>
    )
}
