...
export default function Post({url,is_auth}:{url:string,is_auth?:boolean}) {
  ...
  return (
    <div className='bg-white w-full min-h-40 shadow-card rounded-2xl border border-line relative overflow-hidden'>
        ...
        <div className="text px-4 pb-4">
            ...
            <h1 className='text-2xl font-bold text-orange'><span className='text-primary'>P</span>OST</h1>
