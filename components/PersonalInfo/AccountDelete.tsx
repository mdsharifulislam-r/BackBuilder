  ...
  return (
    <div className='fixed w-full h-screen top-0 left-0 flex justify-center place-items-center'>
      ...
      <form onSubmit={submitHandle} className="md:w-[30%] w-[80%] bg-white  rounded-lg relative z-30 p-5">
        <h1 className='text-2xl font-semibold text-primary p-4 text-center'>Are You sure want delete your <span className='text-orange'>Account?</span></h1>
        ...
        <div>
            ...
            <div className='flex flex-col'>
                ...
                <input type="text" placeholder='' onChange={(e)=>setText(e.target.value)}  name='conPassword' className='px-3 py-1 focus:outline-none my-1 border rounded-lg shadow' />
            </div>
            <div>
                <LoadingButton isLoading={loading} className={`w-full py-1 rounded-lg my-2 ${text=='delete-me'?"bg-red-600":"bg-gray-400"} transition-all duration-500 text-white`}>Change Password</LoadingButton>
            </div>
        </div>
      </form>
