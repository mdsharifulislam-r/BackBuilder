...
export default function SlideCard({image}:{image:any}) {
  return (
    ...
    <div className="md:grid md:grid-cols-2 md:gap-10 lg:gap-16 md:items-center">
      <div className="hidden md:block mb-24 md:mb-0 sm:px-6">
        <div className="relative">
          ...
          <div className="absolute bottom-0 start-0 -z-[1] translate-y-10 -translate-x-14">
            <svg
              className="max-w-40 h-auto text-gray-400 eretext-neutral-700"
              width={696}
              height={653}
              viewBox="0 0 696 653"
              fill="none"
      ...
      <div>
        ...
        <blockquote className="relative">
          <svg
            className="absolute top-0 start-0 transform -translate-x-8 -translate-y-4 size-24 text-gray-200 eretext-neutral-700"
            width={16}
            height={16}
            viewBox="0 0 16 16"
            fill="none"
          ...
          <div className="relative z-10">
            <p className="text-xs font-semibold text-gray-500 tracking-wide uppercase mb-3 eretext-neutral-200">
              Featured client
            </p>
            <p className="text-xl font-medium italic text-gray-800 md:text-2xl md:leading-normal xl:text-3xl xl:leading-normal eretext-neutral-200">
              To say that switching to Backbuilder has been life-changing is an
          ...
          <footer className="mt-6">
            <div className="flex items-center">
              ...
              <div className="ms-4 md:ms-0">
                <div className="text-base font-semibold text-gray-800 eretext-neutral-200">
                  Nicole Grazioso
                </div>
                <div className="text-xs text-gray-500 eretext-neutral-400">
          ...
          <div className="mt-8 lg:mt-14">
            <a
              className="py-3 px-4 inline-flex items-center gap-x-2 text-sm font-medium rounded-lg border border-transparent bg-gray-800 text-white hover:bg-gray-900 focus:outline-none focus:bg-gray-900 disabled:opacity-50 disabled:pointer-events-none erebg-white eretext-neutral-800"
              href="#"
            >
              Read the story
            </a>
