...
export default function PopUp({setShow,endpoint_name}:{setShow:React.Dispatch<React.SetStateAction<boolean>>,endpoint_name:string}) {
  return (
    <div className='p-4 py-5'>
      ...
      <div className='md:w-[30%] min-h-96 bg-white w-[80%] rounded-lg relative z-10'>
          <div className="py-3 bg-primary rounded-lg mx-auto shadow-card -translate-y-2 w-[30%]"></div>
          <div className='text-center'>
            <h1 className='text-2xl text-primary font-bold'><span className='text-orange'>U</span>PDATE</h1>
          </div>
          <AuthMethods/>
